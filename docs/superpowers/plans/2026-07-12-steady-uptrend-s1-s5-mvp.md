...
- [ ] **Step 1: Write failing S1 and S2 tests**

Add fixtures with at least 80 daily bars and 65 weekly bars. Assert S1 accepts exactly `total_mv >= 1_000_000` and `avg_amount_20d >= 200_000`, and S2 enforces the daily/weekly mature-trend conjunction including a 50% MA60 hold ratio.
...
- [ ] **Step 3: Implement the policy and S1/S2 decisions**
...
- [ ] **Step 6: Implement S3 branch metrics and OR recall**
...
- [ ] **Step 8: Implement S4 metrics and hard blockers**
...
- [ ] **Step 9: Run research tests and commit**
...
- [ ] **Step 1: Write failing S5 boundary tests**
...
- [ ] **Step 2: Verify RED, implement S5, and verify GREEN**
...
- [ ] **Step 3: Write failing ordering and rendering tests**
...
- [ ] **Step 4: Implement JSON and Markdown report builders**
...
- [ ] **Step 3: Implement CLI and versioned config**

Read only supplied artifacts, parse approved policy keys, evaluate one signal date, and write with `workflows.jobs.support.write_json_payload`. The config includes `strategy_id="steady_uptrend_s1_s5_mvp_candidate_v1"`, `status="test_tracking"`, and every approved threshold.

- [ ] **Step 4: Run workflow and legacy regression tests**
...
- [ ] **Step 1: Add exact run instructions and output contract**
...
- [ ] **Step 2: Run focused sample replay**
...
- [ ] **Step 4: Run boundary and config validation**
