...
STEADY_UPTREND_BREAKOUT_PRIMITIVES: tuple[PrimitiveHypothesis, ...] = (
    ...
    PrimitiveHypothesis(
        ...
        proposed_logic="volume_ratio_5d_20d >= 1.2",
        reason="确认最近 5 日量能相对 20 日基线持续放大。",
        required_features=("indicator:volume_ratio_5d_20d",),
        threshold_refs=("volume_ratio_5d_20d_high",),
    ),
    PrimitiveHypothesis(
...
def snapshot_from_trend_breakout_metrics(
    ...
    indicators: tuple[tuple[str, object], ...] = (
        ...
        ("volume_ratio_5d_20d", metrics.volume_ratio_5d_20d),
        ...
        ("large_bearish_body_ratio_20d", metrics.large_bearish_body_ratio_20d),
        ("max_consecutive_green_k_20d", metrics.max_consecutive_green_k_20d),
        ("single_bull_bar_return_share_20d", metrics.single_bull_bar_return_share_20d),
        ("impulse_consolidation_days", metrics.impulse_consolidation_days),
        ("ma5_10_20_30_convergence_pct", metrics.ma5_10_20_30_convergence_pct),
        ...
        ("weak_shape_pass", 1 if metrics.weak_shape_pass else 0),
